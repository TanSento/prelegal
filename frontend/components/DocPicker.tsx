...
export default function DocPicker({ onSelect }: DocPickerProps) {
  ...
  return (
    <div className="flex flex-col items-center px-4 py-12">
      ...
      <p className="text-sm text-slate-500 mb-8 text-center max-w-lg">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl w-full">
        {docs.map(({ entry, schema }) => (
          <button
            ...
            className="text-left p-5 rounded-lg border border-slate-200 bg-white hover:border-[#209dd7] hover:shadow-md transition group"
          >
