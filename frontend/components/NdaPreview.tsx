          ...
          <Row label="MNDA Term" hint="The length of this MNDA">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span>
                  Expires{mndaTerm.type === "expires" && mndaTerm.years > 0 && <> <span className="font-medium">{pluralYears(mndaTerm.years)}</span></>} from Effective Date
                </span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <Row label="Term of Confidentiality" hint="How long Confidential Information is protected">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span>
                  {termOfConfidentiality.type === "years" && termOfConfidentiality.years > 0 && <><span className="font-medium">{pluralYears(termOfConfidentiality.years)}</span>{" "}</>}
